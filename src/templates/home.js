      ...
      <Flex background="silver" flexDirection="column">
        ...
        <Flex background="lightgreen">
          <Box>
            ...
            <Text>
              Policies range from 1-8 hours, and can be purchased on the sport,
          ...
          <Box>
            ...
            <Text>
              ...
              when and where it's cheapeast to insure your drone flight.
            </Text>
          </Box>
        </Flex>
        ...
        <Flex background="pink">
          ...
          <Box>
            ...
            <Text>
              From flight assessment insurance, to providing proof-of-insurance
              in your PfCO application, Flock's got you covered.
            </Text>
          </Box>
          <Box>
